...
關於如何有效使用 AI coding agent 的參考資料。
...
- [Anthropic Blog: Harnessing Claude's Intelligence](https://claude.com/blog/harnessing-claudes-intelligence)
- [Anthropic Blog: Skills Patterns](https://claude.com/blog/skills-patterns)
